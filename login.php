...
if (isset($_POST['login'])) {
	if (isset($_POST['email']) && isset($_POST['password'])) {
		...
		$profresult = mysqli_query($con,"SELECT * FROM user WHERE (email='$user_login') AND password='$password_login_md5' AND Wallet_address='0xC18D9745733B83C0102135b629AeAb3F59957A32'");
		$profnum = mysqli_num_rows($profresult);
